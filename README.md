...
누구에게나 이런 사람이 한 명쯤 있다. 양말 한 짝이나 안경이 사라졌을 때 물건만 뒤지지 않는다.
마지막으로 앉았던 소파, 손에 들고 있던 것, 평소의 습관처럼 남들에게는 상관없어 보이는 맥락을
이어 결국 찾아낸다.

문틈에서 조용히 얼굴을 내민 oddsock의 캐릭터가 그런 사람이다. 말없이 사라졌다가 우리가 놓친
맥락과 함께 돌아온다.

**oddsock은 그 사람을 당신의 AI 에이전트 안에 앉혀 둔다.**

공공데이터에서도 답을 잃어버리는 방식은 비슷하다. 가게 하나를 열기 전에 알고 싶은 것은 사람이
늘고 있는지, 비슷한 가게는 얼마나 버티는지, 평일 낮과 주말 밤 중 언제 돈이 쓰이는지다. 생활인구는
사람의 흐름을, 매출은 소비를, 점포와 폐업 이력은 경쟁과 생존을 보여준다. 어느 하나도 혼자서는
질문에 답하지 못한다. 실제 질문은 분야를 가로지르는데, 공공데이터는 기관과 주제별로 나뉘어 있기
때문이다.
