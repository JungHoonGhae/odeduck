...
func (e *Engine) sampleReduction(ctx context.Context, request SampleRequest) (Acquired, error) {
	...
	if source == nil || source.PK != request.PK || source.Document != nil || source.Spatial != nil || source.Reduction != nil || source.Comparison != nil || r.RowsSHA256 == "" || r.RowsSHA256 != source.RowsSHA256 {
