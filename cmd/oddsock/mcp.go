...
import (
	"github.com/JungHoonGhae/oddsock/internal/mcpserver"
...
func mcpCmd() *cobra.Command {
	return &cobra.Command{
		...
		Long: `oddsock 을 Model Context Protocol 서버로 노출합니다(stdio).
...
oddsock://guide 리소스에 사용 순서가 있습니다. 호출·계정 기능은 로그인 세션 전제입니다.`,
